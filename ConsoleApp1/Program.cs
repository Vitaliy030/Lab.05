    ...
    public class Writer
    {
        ...
        public void Add(string surname, string language, int numberOfBooks, string date, string place, int numberOfListeners)
        {
            ...
            while (true)
            {
                ...
                {
                    using (StreamWriter f = new StreamWriter("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp1\\Writers.txt", true))
        ...
        public void Edit(string surname, string language, int numberOfBooks, string date, string place, int numberOfListeners, string[] s0, int n, int count)
        {
            ...
            while (true)
            {
                ...
                {
                    s0[n] = s;
                    using (StreamWriter f = new StreamWriter("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp1\\Writers.txt"))
        ...
        public void Remove()
        {
            int count = File.ReadAllLines("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp1\\Writers.txt").Length;
            ...
            string[] s0 = File.ReadAllLines("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp1\\Writers.txt");
        ...
        public virtual string Calculate_and_Print(string[] surname, string[] data, int[] numberOfListeners, int count)
        {
            int sum = 0;
            ...
            while (true)
            {
                ...
                else if (cki.Key == ConsoleKey.S)
                {
                    ...
                    for (int j = 1; j < count; j++)
                    {
                     ...
                     p.Calculate_and_Print(sr, dt, nm, count);
                }
                else
                    break;
            }
