    ...
    public abstract class Writer
    {
        ...
        public void Add(string surname, string language, int numberOfBooks, string date, string place, int numberOfListeners)
        {
            ...
            while (true)
            {
                ...
                {
                    using (StreamWriter f = new StreamWriter("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp2\\Writers.txt", true))
        ...
        public void Edit(string surname, string language, int numberOfBooks, string date, string place, int numberOfListeners, string[] s0, int n, int count)
        {
            ...
            while (true)
            {
                ...
                {
                    s0[n] = s;
                    using (StreamWriter f = new StreamWriter("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp2\\Writers.txt"))
        ...
        public void Remove()
        {
            int count = File.ReadAllLines("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp2\\Writers.txt").Length;
            ...
            string[] s0 = File.ReadAllLines("D:\\ІТ\\Програмування\\Програми\\Lab.5\\ConsoleApp2\\Writers.txt");
